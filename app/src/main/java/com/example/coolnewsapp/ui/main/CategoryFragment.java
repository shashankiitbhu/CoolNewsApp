...
public class CategoryFragment extends Fragment {
    ...
    public static CategoryFragment newInstance(boolean enabled) {
    ...
    public void getNews(){
        RetrofitClient.ApiClient.getNewsApiInterface().getTechNews("trump","0360e3e2d1dc4e8da356af129a30c807").enqueue(new Callback<TotalHeadlines>() {

...
import com.example.coolnewsapp.MainActivity;
...
import com.example.coolnewsapp.databinding.FragmentTabbedBinding;
...
public class PlaceholderFragment extends Fragment {
    ...
    public static PlaceholderFragment newInstance(boolean enabled) {
    ...
    public void getNews(){
        RetrofitClient.ApiClient.getNewsApiInterface().getTopHeadlines("in","0360e3e2d1dc4e8da356af129a30c807").enqueue(new Callback<TotalHeadlines>() {
